...
class Program
{
    ...
    static void SubstractPoly(int[] polynomial1, int[] polinomial2)
    {
        int[] sumOfPolinomials = new int[polynomial1.Length];
        for (int i = 0; i < polynomial1.Length; i++)
        {
    ...
    static void MultiplicationOfPoly(int[] polynomial1, int[] polinomial2)
    {
        int[] sumOfPolinomials = new int[polynomial1.Length];
        for (int i = 0; i < polynomial1.Length; i++)
        {
    ...
    static void Main()
    {
        ...
        SubstractPoly(polynomial1, polynomial2);
        MultiplicationOfPoly(polynomial1, polynomial2);
    }
}
